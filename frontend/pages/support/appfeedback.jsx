        ...
        <div className="container">
            ...
            <div className="content-body">
                <div id="panel" className="panel-container">
                    <strong>How satisfied are you with our Find Dining App?</strong>
                    ...
                    <div>
                        ...
                        <br />
                        <textarea id="freeform" name="freeform" rows="4" cols="50" placeholder="Enter text here..." className="feedback-textarea    ">
